...
This paper is thus a first assessment on the feasibility of designing loss functions specifically for the multilabel setting based on statistical and information retrieval metrics.
