...
\daan{Proposal: We formalize learning tasks that match these four criteria as Single-Instance Multilabel Prediction for Unknown Label counts (SIMPUL). }

\daan{Can go to related work.}
...
\daan{Maybe save some for related work, but most of it feels irrelevant to me.}
