...
\end{equation}
\label{eq:estimand}
\mdr{I am confused by the use of the word ``shall'' in the statement of the proposition. A proposition is meant to establish a (minor) mathematical fact; a modality such as ``shall'' does not fit such statements.}
\end{proposition}
