...
In this section \mdr{we recall the background material needed to be able to introduce our proposed solution to the U-I, MC, ML prediction problem with a VNofL}.
