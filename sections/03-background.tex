...
\daan{I feel that there is more to get out of this section. If we can get from a clear problem formulation, with the two attack vectors (problem transformation and algorithm adaptation) to a clear gap, that would make a beautiful flow from intro to our method.}
