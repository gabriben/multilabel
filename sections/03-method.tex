...
Following Equation \ref{eq:unbounded}, it is possible to define an \emph{unbounded F1} score (see~\cite{softF1} for a similar formulation\footnote{To give tribute to the previous formulation, we specify here that unboundedF1 was called softF1 in this blog post.}):
%
\begin{equation}
