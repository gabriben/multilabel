...
We show the sensitivity of sigmoidF1 to different parametrizations of $\eta$ and $\beta$. It is clear from Figure \ref{fig:betaEta} that results on test set are sensible to the choice of $\eta$ and $\beta$. 

\begin{figure*}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./images/betaEta.png}
\caption{\label{fig:betaEta}
DistilBert on Arxiv2020 – different scores on the test data at a 0.5 threshold for different values of Eta and Beta.}
\end{figure*}
