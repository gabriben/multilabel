...
\begin{subtable}[t]{.95\columnwidth}
  \caption{Performance@0.5 of MobileNetV2 (CNN) + custom classification head on Movie posters}
...
\quad
\begin{subtable}[t]{.95\columnwidth}
  \caption{Performance@0.5 of DistilBert (NLP) + custom classification head on  arXiv 2020}
  \label{tab:arxiv2020}  
\centering
\begin{tabular}{l ccccc}
\toprule
...
\vspace{2mm}
\begin{subtable}[t]{.95\columnwidth}
  \caption{Performance@0.5 of DistilBert (NLP) + custom classification head on Cancer Hallmarks}
...
\quad
\begin{subtable}[t]{.95\columnwidth}
  \caption{Performance@0.5 of DistilBert (NLP) + custom classification head on Chemical Exposure}
