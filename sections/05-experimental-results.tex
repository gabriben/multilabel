...
$\mathcal{L}_{\text {sigmoidF1}}$ & \textbf{0.068} & \textbf{0.269} & \textbf{0.154} & \textbf{0.081} & \textbf{0.144} \\ % run aa424792a57e4208ad1805cd6e63f8e6
\bottomrule
\end{tabular}
\end{table}
...
$\mathcal{L}_{\text {sigmoidF1}}$ & \textbf{0.094} & \textbf{0.423} & \textbf{0.285} & \textbf{0.079} & \textbf{0.154} \\ % run bd478ca55eb64cc78d9ad0f25accce35 (18-19 jan)
\bottomrule
\end{tabular}
\end{table}
